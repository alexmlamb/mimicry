...
add_name='LSUN_NFL_BASELINE'
#baseline_informax_lsun_example.py
python /home/anirudh/nips2020/mimicry/examples/baseline_informax_lsun_example.py --name $add_name
#dim1=$1
#em=$1
#block1=$2
#topk1=$3
