...
from rims_cnn_mlp import RIMS_CNN_MLP
...
parser.add_argument('--save', type=str, default='./results/model/')
...
parser.add_argument('--use_nfl', action='store_true')
...
elif args.model == "RIMS_CNN_MLP":
    model = RIMS_CNN_MLP(args)
else:
    print(args.model)
