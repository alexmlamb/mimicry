...
class AttentiveDensenet(nn.Module):
    def __init__(self, layer_channels, key_size, val_size, n_heads, att_sparsity,attn_dropout=0.0,concentration=0.5, position_attend=True):
        ...
        for ch in layer_channels:
            ...
            out_layer = nn.Sequential(nn.Conv2d(val_size*n_heads,ch,3,stride=1,padding=1), nn.ReLU(), nn.Conv2d(ch, ch,3,stride=1,padding=1))
